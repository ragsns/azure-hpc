...
[![Click to deploy template on Azure](http://azuredeploy.net/deploybutton.png "Click to deploy template on Azure")](https://raw.githubusercontent.com/ragsns/azure-hpc/master/Compute-Grid-Infra/deploy-master.json)  
